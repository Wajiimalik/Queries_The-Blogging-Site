...
CREATE TABLE PAST_EXPERIENCE
(
	PE_ID int NOT NULL IDENTITY(1,1)  PRIMARY KEY, USER_ID int, EXPERIENCE varchar(200) NOT NULL
)
GO

CREATE TABLE ADMIN_DRAFT
(
	ADMIN_DRAFT_ID int NOT NULL IDENTITY(1,1) PRIMARY KEY, ADMIN_ID int NOT NULL
)
GO

CREATE TABLE CW_DRAFT
(
	CW_DRAFT_ID int NOT NULL IDENTITY(1,1) PRIMARY KEY, CW_ID int NOT NULL
)
GO

CREATE TABLE COMMENT_ON
(
	SUBMITTED_ARTICLE_ID int NOT NULL IDENTITY(1,1) PRIMARY KEY, COMMENT_BODY varchar(1000) NOT NULL, DATE_TIME smalldatetime
)
GO

CREATE TABLE CW_PUBLISH
(
	CW_ID int NOT NULL IDENTITY(1,1) PRIMARY KEY, PUBLISHED_ARTICLE_ID int NOT NULL
)
GO