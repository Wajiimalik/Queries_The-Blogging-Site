...
(
	...
	DATE_TIME smalldatetime DEFAULT GETDATE() 
)
GO
...
( 
	...
	TITLE varchar(255) NOT NULL UNIQUE, 
	SUBTITLE varchar(255) NOT NULL UNIQUE, 
	BLOG_CONTENT varchar(500) NOT NULL UNIQUE, 
	DATE_TIME smalldatetime DEFAULT GETDATE(),
...
(
	ADMIN_DRAFT_ID int NOT NULL PRIMARY KEY,
...
(
	CW_DRAFT_ID int NOT NULL PRIMARY KEY,
	CW_ID int NOT NULL
)
GO
